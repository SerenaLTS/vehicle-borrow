-- Safe additive migration for an existing production database.
-- Purpose:
-- 1. Keep all existing data
-- 2. Add booking support
-- 3. Add expected_return_at support for borrows
-- 4. Prevent overlaps between bookings and borrows
